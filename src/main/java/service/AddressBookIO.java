...
public class AddressBookIO {
    ...
    // CSV File Path
    File csvFile = new File("AddressBookCSV.csv");

    //GSON File Path
    File gsonFile = new File("AddressBookGSON.json");
        ...
        try {
            while ((contact = csvReader.readNext()) != null) {
                Contact newContact = new Contact(contact[1], contact[2], contact[3], contact[4], contact[5],
                        Integer.parseInt(contact[6]), Integer.parseInt(contact[7]), contact[8]);
